"GameInfo"
{
	...
	FileSystem
	{
		SteamAppId				1024290		// This will mount all the GCFs we need (240=CS:S, 220=HL2).
		ToolsAppId				1024290		// Tools will load this (ie: source SDK caches) to get things like materials\debug, materials\editor, etc.
